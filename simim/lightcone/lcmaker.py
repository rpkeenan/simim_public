...
class LCMaker():
    ...
    def __init__(self,
        ...
        openangle : float
            The opening angle of the light cone, specified in degrees. For
            circular light cones this will be the diameter of the light cone,
            for square light cones this will be the side length of the box, for
            rectangular light cones this will be the length of the longer side
        aspect : float beteen 0 and 1, optional
            The aspect ratio for the sides of a rectangular box, the long side
            is determined by openangle and the short side is aspect x openangle
        redshift_min : float, optional
            Minimum redshift to include in the lightcone, default is 0
        redshift_max : float or 'max', optional
            Maximum redshift to include in the lightcone, default is the maximum
